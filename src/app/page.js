...
export default function HomePage() {
  ...
  <div className="md:max-w-frame mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
    <section className="max-w-frame px-4 md:mt-12 md:ml-8 md:text-left text-center">
      ...
      <div>
        <a
          className="w-full md:w-52 mb-5 md:mb-12 inline-block text-center hover:animate-pulse bg-black hover:bg-black/80 transition-all text-white px-14 py-4 rounded-full "
          href="/shop"
        >
          Shop Now
        </a>
